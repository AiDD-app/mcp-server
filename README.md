...
For detailed information about our data handling practices, please review our [Privacy Policy](https://www.aidd.app/privacy).

### Data Processing
- Apple Notes content is processed temporarily and never permanently stored
- AI processing occurs on secure backend servers with encryption in transit
- Authentication tokens are stored locally at `~/.aidd-mcp/auth-credentials.json`
